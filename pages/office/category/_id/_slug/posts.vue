            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><nuxt-link to="/office/category/">Categories</nuxt-link></li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">All Blog Posts in <b style="color: #083040"> {{ category_title }} </b></h4>

                            <div style="float:right;">
                                <nuxt-link to="/articles/add-article" class="btn btn-primary">Add Article</nuxt-link>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                            ...
                            <template v-else>
                                ...
                                <v-client-table :data="all_blogs" :columns="all_blogs_columns" :options="all_blogs_table_options" class="table-responseive">
                                    <template v-slot:action="item">
                                        <nuxt-link class="btn btn-primary btn-xxs" :to="`/office/blog/${ item.row['id'] }/edit/`" v-if="$store.state.auth.user.role_id == 1 | $store.state.auth.user.role_id == 2">Edit</nuxt-link>
...
export default {
  ...
  async fetch() {
        ...
        let res = await this.$store.dispatch("blog/getBlogPostsByCategory", data);
        //console.log(res.message)
        this.all_blogs = res.message;
        this.image_path = res.image_path
        this.category_title = res.message[0].category.title
  },
};
</script>