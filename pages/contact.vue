    ...
    <div>
		...
		<main role="main">
			...
			<section class="section section--no-pt section--no-pb">
				...
				<!--<div id="g_map--0001" class="g_map" data-api-key="" data-longitude="44.958309" data-latitude="34.109925" data-marker="/img/marker.png"></div> -->
									...
									<div class="__inner">
										<div class="row">
											...
											<div class="col col--sm-6 col--md-12">
												<div class="__item">
													<i class="__ico">
														<img class="img-responsive" src="/img/blank.gif" data-src="/img/ico/ico_phone.png" width="24" height="44" alt="demo" />
													</i>
													...
													<div>
														...
														<span>
															<a href="tel:+2348134277988">2348134277988</a>
															<br>
															<a href="tel:+2348134277988">2348134277988</a>
														</span>
													</div>
											...
											<div class="col col--sm-6 col--md-12">
												<div class="__item">
													...
													<div>
														...
														<span>
															<a href="mailto:danielozeh@gmail.com">danielozeh@gmail.com</a>
														</span>
													</div>
												</div>
											</div>
							...
							<div class="col col--md-7 col--lg-8">
								<div class="posts-feedback">
									<form class="js-contact-form" action="#">
										...
										<div class="input-wrp">
											<textarea class="textfield" name="message" placeholder="Message"></textarea>
										</div>
...
export default {
  ...
  head() {
    return {
      title: 'Contact Us',
	  meta: [
		  { hid:'description', name: 'description', content: this.site_description }
	  ]
    }
  },
  ...
  async fetch() {
	  let res = await this.$store.dispatch("settings/getSettings");
      this.settings = res.message;
	  this.site_title = this.settings.site_title
	  this.site_description = this.settings.settings
  }
}
</script>