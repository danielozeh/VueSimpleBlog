									...
									<div class="col col--sm-6 col--lg-4" v-for="blog in blog_posts.message" :key="blog.id">
										...
										<div data-aos-delay="100" data-aos-offset="0">
											<div class="__item __item--preview">
												...
												<div class="__content">
													<p class="__category"><nuxt-link :to="`/blog/category/${ blog.category_id }`">{{ blog.category.title }}</nuxt-link></p>
...
export default {
  ...
  async fetch() {
	  ...
	  this.blog_posts = await this.$store.dispatch("blog/getBlogPosts", data);
